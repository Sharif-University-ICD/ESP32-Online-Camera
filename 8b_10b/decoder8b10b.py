class EncDec_8B10B(object):
    dec_lookup = [
        ...
        "010101101",  # "1010001101", +D13.2+, [342,303]
    ...
    enc_lookup = [
        ...
        "01000110101",  # "11111111" -D31.7- [255] runningdisparity = 0
        ...
        "10111001010",  # "11111111" +D31.7+ [511] #runningdisparity = 1
        ...
        "00001110101",  # "11111111" -K31.7- [767] #runningdisparity = 2
        ...
        "11110001010"  # "11111111" +K31.7+ [1023] #running disparity = -1
    ]
    ...
    def dec_8b10b(data_in, verbose=False):
        ...
        return ctrl, decoded
for i in (0x266, 0x247, 0x1D6, 0x2E5, 0x117, 0x355, 0x28D, 0x09D):
    i_hex = "{0:x}".format(i)
    print(i_hex, "{0:x}".format(EncDec_8B10B.dec_8b10b(i)[1]))